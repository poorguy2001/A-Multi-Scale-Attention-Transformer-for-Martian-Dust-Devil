...
class v8DetectionLoss:
    ...
    def __init__(self, model):  # model must be de-paralleled
        ...
        # self.bce = QualityfocalLoss()  # SlideLoss
        # self.bce = SlideLoss(nn.BCEWithLogitsLoss(reduction='none'))  # SlideLoss
        self.bce = nn.BCEWithLogitsLoss(reduction='none') #ori
        self.hyp = h
    ...
    def __call__(self, preds, batch):
        ...
        if fg_mask.sum():
            ...
            loss[0], loss[2] = self.bbox_loss(pred_distri, pred_bboxes, anchor_points, target_bboxes, target_scores,
                                              target_scores_sum, fg_mask ,((imgsz[0] ** 2 + imgsz[1] ** 2) / torch.square(stride_tensor)).repeat(1,
